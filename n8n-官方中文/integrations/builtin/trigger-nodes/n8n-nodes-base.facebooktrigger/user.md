---
title: Facebook 触发器 User 对象文档
description: >-
  Learn how to use the User object of the Facebook Trigger node in n8n.
contentType:
  - integration
  - reference
priority: medium
nodeTitle: Facebook 触发器 User 对象文档
...
# Facebook 触发器 User（用户）对象

> **大白话**：这个对象监听用户资料的变动——比如用户改了头像、改了名字、改了资料字段等，都会触发你的工作流。

使用此对象来接收用户资料发生变更时的更新。关于触发器本身的更多信息，请参阅 [Facebook 触发器](README.md)。
...
更多信息请参阅 Meta 的 [User](https://developers.facebook.com/docs/graph-api/webhooks/reference/user/) Graph API 参考文档。
